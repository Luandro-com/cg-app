...
export const blogDataUrl = (page, range) => `${apiUrl}wp/v2/posts?page=${page}&_embed&_query=[${range}].{image: better_featured_image.source_url, slug: slug, title: title.rendered, text: excerpt.rendered, author: _embedded.author[0].name, date: date}`;
